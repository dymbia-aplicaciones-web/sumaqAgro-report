...
* Atlassian. (s. f.). Source code management: What is SCM and why does it matter?. Recuperado https://www.atlassian.com/git/tutorials/source-code-management
* Cloudflare. (s. f.). Cloudflare Pages: Deploy web applications in seconds. Recuperado https://www.cloudflare.com/products/pages/
* Conventional Commits. (s. f.). Conventional Commits 1.0.0. Recuperado https://www.conventionalcommits.org/en/v1.0.0/
...
* Figma. (s.f.). Figma: The collaborative interface design tool [Software de computación]. https://www.figma.com
* GitHub. (s. f.). GitHub: Let’s build from here. Recuperado  https://github.com/
* Goo.su. (s. f.). Goo.su: Acortador de URL [Software en línea]. https://goo.su/page/acortador-de-url
...
* JetBrains. (s. f.). IntelliJ IDEA [Software de computación]. recuperado https://www.jetbrains.com/idea/
* Atlassian. (s. f.). Jira: Software de seguimiento de proyectos y problemas para equipos ágiles. Recuperado https://www.atlassian.com/es/software/jira
...
* Miro. (s. f.). El espacio de innovación con IA. https://miro.com/es/
